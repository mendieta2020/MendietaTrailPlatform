...
- Connect athlete accounts to third-party activity providers (e.g. Strava) via OAuth.
- Receive completed activity data from those providers.
- Apply evidence-based analytics (training load, PMC, injury risk) to the resulting data.
- Review Plan vs Real deviations and adapt future training plans accordingly.

The Service is **not** a social network, a public activity sharing platform, or a consumer
fitness application.
...
Athletes are added to the platform by their coach. Athletes may connect or disconnect
third-party provider integrations at any time. Athletes are not directly billed by Quantoryn.
...
- Commercially resell access to the Service without a written agreement.
...
Quantoryn is provided on an **"as-is" and "as-available" basis**. We do not guarantee
...
- Quantoryn is not liable for any indirect, incidental, consequential, or punitive damages
...
Quantoryn may suspend or terminate access to the Service if:

- These Terms are violated.
- Payment is not received (where applicable).
- Continued operation of the account poses a security risk.

Upon termination, athlete data will be retained for 30 days to allow export, then deleted.
...
recent revision. Continued use of the Service after changes are posted constitutes acceptance
