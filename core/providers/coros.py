"""
Coros OAuth integration provider — STUB (disabled).

Status: Coming Soon — not yet enabled for production.

Notes:
- Coros uses OAuth 2.0 authorization code flow.
- Requires COROS_CLIENT_ID + COROS_CLIENT_SECRET in settings.
- API docs: https://open.coros.com/
"""
...
class CorosProvider(IntegrationProvider):
    """
    Coros integration provider stub.
    ...
    def get_oauth_authorize_url(self, state: str, callback_uri: str) -> str:
        raise NotImplementedError(
            "CorosProvider is not yet implemented. "
